...
// Use environment variables for Vercel deployment, with fallback to JSON
const config = {
...
export { collection, addDoc, getDocs, query, orderBy, onSnapshot, signInWithPopup, signOut };
